...
function optionsConflicts(inputArgs) {

    console.log(`Try the following:
    pear dev . optionsConflicts --HELP
    pear dev . optionsConflicts pay --cash --credit-card
    pear dev . optionsConflicts source
    pear dev . optionsConflicts source --interactive
    pear dev . optionsConflicts source --port 8080 --interactive
    pear dev . optionsConflicts source --interactive
    pear dev . optionsConflicts paint --colour=red --summer
    pear dev . optionsConflicts paint --no-colour --autumn`)
...
const _optionsConflicts = optionsConflicts
export { _optionsConflicts as optionsConflicts };
