...
function globalOptionsAdded(inputArgs) {

  console.log(`Try the following:
  pear dev . globalOptionsAdded --HELP
  pear dev . globalOptionsAdded print --HELP
  pear dev . globalOptionsAdded serve --HELP
  pear dev . globalOptionsAdded serve --debug --verbose`)
...
const _globalOptionsAdded = globalOptionsAdded
export { _globalOptionsAdded as globalOptionsAdded };
